...
export abstract class ItemState {
  ...
  abstract transition(env: Environment): ItemState
...
export class NoItemFirstState extends NoItemState {
  transition(env: Environment): ItemState {
...
export class NoCoupleState extends FirstSightState {
  ...
  transition(env: Environment): FirstSightState {
    const nextMale: ItemState = this.maleState.transition(env)
    const nextFemale: ItemState = this.femaleState.transition(env)
